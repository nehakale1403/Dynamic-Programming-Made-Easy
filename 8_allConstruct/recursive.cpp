...
vector<vector<string>> allConstruct(int n, string wordBank[], string target){
    ...
    for(int i=0; i<n; i++){
        ...
        if(pos == 0){
            ...
            vector<vector<string>> suffixWays = allConstruct(n, wordBank, new_target);
...
int main(){
    ...
    vector<vector<string>> result = allConstruct(n, wordBank,target);
